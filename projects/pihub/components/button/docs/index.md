...
<table>
    ...
    <tr>
        ...
        <td>{{ NgDocActions.demo("ButtonComponent", {class: "center", container: false, inputs: {title: "Example", style: "primary", disabled: true} }) }}</td>
				<td>{{ NgDocActions.demo("ButtonComponent", {class: "center", container: false, inputs: {title: "Example", style: "secondary", disabled: true} }) }}</td>
				<td>{{ NgDocActions.demo("ButtonComponent", {class: "center", container: false, inputs: {title: "Example", style: "tertiary", disabled: true} }) }}</td>
    </tr>
</table>
